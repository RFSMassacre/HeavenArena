...
public abstract class DataManager extends Manager
{
     ...
     */
    protected abstract void storeData(Object object, YamlConfiguration data) throws IOException;

    protected abstract Object loadData(YamlConfiguration data) throws IOException;
}
